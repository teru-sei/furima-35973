  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'last_name_kaが空では登録できない' do
        @user.last_name_ka = ''
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name ka can't be blank", "Last name ka is invalid. Input full-width katakana characters")
      end
      it 'first_name_kaが空では登録できない' do
        @user.first_name_ka = ''
        @user.valid?
        expect(@user.errors.full_messages).to include("First name ka can't be blank", "First name ka is invalid. Input full-width katakana characters")
      end
